...
public class Configuration : IPluginConfiguration
{
    ...
    public void Save()
    {
        OceanFishingReminder.PluginInterface.SavePluginConfig(this);
    }
}
...
public class OceanFishingReminder : IDalamudPlugin
{
    ...
    private void CheckOceanFishingTimer()
    {
        ...
        if (nextFishingTime <= time)
            nextFishingTime = nextFishingTime.AddHours(2);
